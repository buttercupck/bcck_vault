...
# ATTACK VECTOR 1: Query Substitution (CRITICAL)
# Test if LOW-PRIV account can execute HIGH-PRIV CrmObjectsSearchQuery

echo "=========================================="
echo "TEST 1: QUERY SUBSTITUTION ATTACK"
echo "=========================================="
echo ""
echo "TARGET: LOW-PRIV account (buttercup_ck@bugcrowdninja.com)"
echo "ATTACK: Execute CrmObjectsSearchQuery instead of FetchContactSuggestions"
echo ""

# LOW-PRIV credentials (from provided curl)
...
# Test 1: Execute HIGH-PRIV query with LOW-PRIV credentials
echo "TEST 1A: Execute CrmObjectsSearchQuery (25 contacts) with LOW-PRIV account"
echo "Expected: 403 Forbidden or authorization error"
echo "Vulnerability: If successful, horizontal privilege escalation confirmed"
echo ""
