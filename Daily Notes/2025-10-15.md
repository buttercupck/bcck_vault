...
## 🔍 HubSpot Bug Bounty Discovery - GraphQL Investigation
...
**The Test**:
1. Run query with YOUR account ID ✅ Works
2. Try SOMEONE ELSE's account ID ❌ Should fail
3. If it works → You found an IDOR bug! 💰
...
1. ✅ **DONE**: Found and analyzed Apollo bundle
2. ✅ **DONE**: Created service map with 40+ services
3. ✅ **DONE**: Identified GraphQL architecture
4. ⏭️ **NEXT**: Open Chrome DevTools and capture real GraphQL queries
5. ⏭️ **NEXT**: Test `/graphql` endpoint for introspection
6. ⏭️ **NEXT**: Dump `window.__APOLLO_CLIENT__` to see cached data
7. ⏭️ **NEXT**: Try changing IDs in GraphQL queries (IDOR testing)
8. ⏭️ **NEXT**: Test payment endpoints for price manipulation
