...
<head>
    ...
    <title>Tirzepatide - JPeptics Research Peptides</title>
    <style>
        ...
        * {
        ...
        /* COA Section */
        .coa-section {
            background: var(--primary-magenta-pale);
            border-radius: var(--radius-xl);
            padding: 3rem;
            margin: 4rem 0;
...
<body>
    ...
    <section class="section">
        <div class="container">
            <div class="product-detail">
                <div class="product-images">
                    <div class="main-image-container">
                        <img id="mainImage" src="https://f004.backblazeb2.com/file/jpeptics/assets/TZ-0925/TZ-Label.png" alt="Tirzepatide" class="main-image">
                    </div>
                </div>
                <div class="product-info">
                    ...
                    <form method="POST" action="order-form.php">
                        <input type="hidden" name="product" value="tirzepatide">
            ...
            <div class="coa-section">
                ...
                <div class="coa-image">
                    <img src="assets/products/TZ/TZ-3PK-PACK-A-JP-TIRZ-0925.svg" alt="JPeptics" alt="3-PK-TZ">
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        const packageImages = {
            '3-pack-179': {
                url: 'https://f004.backblazeb2.com/file/jpeptics/assets/TZ-0925/TZ-3PK-PACK-A-JP-TIRZ-0925.png.png',
                alt: '3 Pack Tirzepatide'
            },
            '6-pack-339': {
                url: 'https://f004.backblazeb2.com/file/jpeptics/assets/TZ-0925/TZ-6PK-PACK-A-JP-TIRZ-0925.png.png',
                alt: '6 Pack Tirzepatide'
            },
            '10-pack-529': {
                url: 'https://f004.backblazeb2.com/file/jpeptics/assets/TZ-0925/TZ-10PK-PACK-A-JP-TIRZ-0925.png.png',
                alt: '10 Pack Tirzepatide'
            }
        };

        const labelImage = {
            url: 'https://f004.backblazeb2.com/file/jpeptics/assets/TZ-0925/TZ-Label.png',
            alt: 'Tirzepatide Label'
        };
